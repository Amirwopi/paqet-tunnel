...
#### v1.11.4
- **Server B Uninstall Fix** - Uninstall no longer aborts on abroad servers; shows the server instance and removes iptables rules for the configured listen port.
